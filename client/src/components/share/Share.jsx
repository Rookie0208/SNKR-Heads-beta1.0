    ...
    <div className='share'>
        <div className='sharewrapper'>
            <div className='sharetop'>
                ...
                <input type='text' className='shareinput' placeholder={'Drop your Drip here ' + user.username} ref={desc}>  
                </input>
            </div>
            <hr className='sharehr'/>
            {file && (
                <div className='shareimgcontainer'>
                    <img className='shareimg' src={URL.createObjectURL(file)} alt='post-image'/>
